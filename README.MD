...
To [dynamically update](https://en.wikipedia.org/wiki/Dynamic_software_updating) the servlet code you just need to rebuild run the command `mvn clean package` from the `/bundle` directory of the project
