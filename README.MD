...
* [build](https://github.com/softalks/dsu.example/blob/main/contexts/static/pom.xml) and deploy the WAR file providing the `/static` web context and the `/static/hello` servlet
