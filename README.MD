...
* [build](https://github.com/softalks/osjee.dropins.example/blob/main/contexts/dynamic/pom.xml) the WAR application providing the `/dynamic` web context and deploy it to the server dropins directory
