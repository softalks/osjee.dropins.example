...
* from the `bundle` directory to update the [dynamic](https://en.wikipedia.org/wiki/Dynamic_software_updating) servlet
* from the `contexts/static` directory to update the static servlet
